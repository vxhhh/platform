<template>
    <el-container class="home_container">
        <el-header>
            <div class="home_title">锯片交易信息平台后台管理系统</div>
        </el-header>
        <el-container>
            ...
            <el-aside width="200px" style="background-color: #a5e7f0">
                ...
                <el-menu router>
                    ...
                    <el-submenu :index="0">
                        <template slot="title"><i class="el-icon-goods"></i>商品模块</template>
                        <el-menu-item index="/productManage">
                            <div style="position: relative;left: 20px;">
                                <i class="el-icon-s-unfold"></i>商品管理
                            </div>
                        </el-menu-item>
                    ...
                    <el-submenu :index="1">
                        <template slot="title"><i class="el-icon-finished"></i>数据统计</template>
                    ...
                    <el-submenu :index="2">
                        <template slot="title"><i class="el-icon-finished"></i>信息管理</template>
                        <el-menu-item index="/Blogs">
                            <div style="position: relative;left: 20px;">
                                <i class="el-icon-s-data"></i>信息列表
                            </div>
                        </el-menu-item>
                        <el-menu-item index="/blog/add">
                            <div style="position: relative;left: 20px;">
                                <i class="el-icon-s-marketing"></i>发布信息
                            </div>
                        </el-menu-item>
                    </el-submenu>
